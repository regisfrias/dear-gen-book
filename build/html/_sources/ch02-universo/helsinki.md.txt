...
![](../assets/02-2018-5-24-18-29-45-planets-orbit.png)
...
![Position of known exoplanets in the sky](../assets/02-2018-5-24-18-41-19-planets-positions.png)
...
![The final image printed on the postcard](../assets/02-2018-5-28-11-15-34-PL_ORBPER.png)

![](../assets/02-2018-5-28-11-18-40-PL_ORBPER.png)
...
![Detail of the image generated based on Orbital Period (days)](../assets/02-pl_orbper.png)

The same area in an image generated with `PL_MASSE` looks like this:

![Detail of the image generated based on Planet Mass (Earth mass)](../assets/02-pl_masse.png)

And with `PL_RADE`:

![Detail of the image generated based on Planet Radius (Earth radii)](../assets/02-pl_rade.png)

Which amounts to:

![Orbital Period](../assets/02-2018-5-24-18-29-45-planets-orbit.png)

![Planet Mass](../assets/02-2018-5-24-18-32-31-planets-mass.png)

![Planet Radius](../assets/02-2018-5-24-18-33-59-planets-radius.png)
