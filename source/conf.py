...
# -*- coding: utf-8 -*-
#
# Dear Gen documentation build configuration file, created by
...
# Half Scheidl, added support for Markdown. requires commommark to be installed
...
man_pages = [
    (master_doc, 'deargen', 'Dear Gen Documentation',
     [author], 1)
]
